...
def _serialize_billing_invoice_row(inv: Invoice) -> dict:
    ...
    row = {
        ...
        "patient_iris_tag": bool(getattr(inv.patient, "iris_tag", False)),
...
def _invoice_bill_dict(inv: Invoice, *, preview: bool) -> dict:
    ...
    return {
        **header,
        ...
        "patient_iris_tag": bool(getattr(pat, "iris_tag", False)),
    ...
    def patients(self, request):
        ...
        for p in patients_qs:
            ...
            data.append({
                ...
                "iris_tag": bool(getattr(p, "iris_tag", False)),
            })
        return Response(data)
        ...
        return Response(
            {
                ...
                **patient_saved_card_display(patient),
                ...
                "iris_tag": bool(getattr(patient, "iris_tag", False)),
