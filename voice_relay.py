...
Supports multi-service booking: 15-min break between chiro and massage (or massage segments); back-to-back chiropractic has no buffer.
...
def _inter_visit_buffer_minutes(prev: "ServiceEntry", next_svc: "ServiceEntry") -> int:
    """No scheduled gap between two chiropractic visits; 15 minutes when visit types differ."""
    if prev.service_type == "chiropractic" and next_svc.service_type == "chiropractic":
        return 0
